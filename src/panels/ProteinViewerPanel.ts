...
export class ProteinViewerPanel {
  ...
  private constructor(
    ...
    clickedFiles: vscode.Uri[] | undefined,
    initialFileIndex = 0
  ) {
    this._panel = panel;
  ...
  public static renderFromFiles(extensionUri: vscode.Uri, clickedFiles: vscode.Uri[], initialFileIndex = 0) {
  ...
  private _getWebviewContentForFiles(
    webview: vscode.Webview,
    extensionUri: vscode.Uri,
    clickedFiles: vscode.Uri[],
    initialFileIndex: number
  ) {
    const fileDescriptors: StructureFileDescriptor[] = clickedFiles.map((clickedFile) => {
  ...
  private _wrapWebviewHtml(webview: vscode.Webview, extensionUri: vscode.Uri, controlsMarkup: string, scriptBody: string) {
  ...
  private _getStructureFileInfo(clickedFile: vscode.Uri) {
